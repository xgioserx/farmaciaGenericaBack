...
$content .= "<u><h1 style='margin-top: -50px;'>Reporte Ventas</h1></u>";
...
$content .= "</table>";
$content .= "<h4 style='margin-top: 15px;'>cantidad de ventas: " . $cont . "</h4>";
$content .= "</page>";

$html2pdf = new Html2Pdf('P', 'A4', 'es');
$html2pdf->writeHTML($content);
ob_end_clean();
$html2pdf->output('reporte_ventas.pdf', 'I');
