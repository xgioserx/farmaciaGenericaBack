...
$content .= "<u><h1 style='margin-top: -50px;'>Reporte Clientes</h1></u>";
    ...
    for ($i = 0; $i < count($arr[0]); $i++) {
        if ($i == 4) {
            if ($arr[$cont][$keys[$i]] == 0) {
                $content .= "<td><b>Masculino</b></td>";
            } else {
                $content .= "<td><b>Femenino</b></td>";
            }
        } else {
...
$content .= "</table>";
$content .= "<h4 style='margin-top: 15px;'>cantidad de clientes: " . $cont . "</h4>";
$content .= "</page>";

$html2pdf = new Html2Pdf('P', 'A4', 'es');
$html2pdf->writeHTML($content);
ob_end_clean();
$html2pdf->output('reporte_clientes.pdf', 'I');
